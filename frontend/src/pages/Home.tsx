    ...
    <div className="home-page">
      ...
      <section className="home-section">
        ...
        <div className="video-embed-wrapper" style={{ display: 'flex', justifyContent: 'center', margin: '2rem 0' }}>
          <a
            href="https://www.youtube.com/watch?v=bGYbpUUhR1E"
            target="_blank"
            rel="noopener noreferrer"
            style={{ position: 'relative', display: 'inline-block', borderRadius: '12px', overflow: 'hidden' }}
          >
            <img
              src="https://img.youtube.com/vi/bGYbpUUhR1E/maxresdefault.jpg"
              alt="Cresco Demo Video"
              width="720"
              height="405"
